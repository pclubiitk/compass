      ...
      <CardContent className="space-y-2 px-3 pb-3 pt-0">
        ...
        <div className="rounded-lg px-3 py-2 bg-linear-to-r from-rose-100/90 to-pink-100/90 border border-rose-200/50 space-y-2">
          ...
          <div className="flex gap-2">
            <div className="flex-1 rounded-md bg-blue-50/80 border border-blue-200/50 px-2 py-1 text-center">
            ...
            <div className="flex-1 rounded-md bg-pink-50/80 border border-pink-200/50 px-2 py-1 text-center">
