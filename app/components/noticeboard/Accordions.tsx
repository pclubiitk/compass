    ...
    value={hashId||''}>
        ...
        <NoticeCard id="sherlock"
            ...
            <div className="space-y-3">
                <h4 className="font-semibold text-lg">🚲 Campus Cycle Theft Investigation</h4>
                ...
                <div className="bg-blue-800 p-3 rounded-md border border-blue-100">
                    <h5 className="font-medium mb-1">🔒 Immediate Safety Measures:</h5>
        ...
        <NoticeCard id="doraemon"
            ...
            discription={
            <div className="space-y-3">
                <h4 className="font-semibold text-lg">🤖 Doraemon&apos;s Campus Visit</h4>
                <div className="flex flex-col items-center">
                <Image 
                    src="/doraemon.svg" 
                ...
                <div className="bg-green-800 p-3 rounded-md border border-green-100">
                    <h5 className="font-medium mb-1">📅 Special Events Schedule:</h5>
                    <ul className="list-disc pl-5 space-y-1">
        ...
        <NoticeCard id="unicorn"
            ...
            discription={
                <div className="space-y-3">
                <h4 className="font-semibold text-lg">✨ Unicorn in Botanical Gardens</h4>
                <div className="flex flex-col items-center">
                    <Image 
                    src="/unicorn.svg" 
            ...
            discription={
                <div className="space-y-3">
                <h4 className="font-semibold text-lg">🔥 Dragon Roost Established</h4>
                <div className="flex flex-col items-center">
                    <Image 
                    src="/dragon.svg" 
        ...
        <NoticeCard id="pheonix"
            ...
            discription={
            <div className="space-y-3">
                <h4 className="font-semibold text-lg">🔍 Extraordinary Wildlife Sighting</h4>
                <div className="flex flex-col items-center">
                <Image 
                    src="/pheonix.svg" 
